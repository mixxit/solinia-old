...
//		theCharScanScript->setOutputName("lvl1_inactive_");
//
//		theCharScanScript->addInfoExtractor("Name");
//		theCharScanScript->addInfoExtractor("Position");
//		theCharScanScript->addInfoExtractor("DeathPenalty");
//		theCharScanScript->addInfoExtractor("Stats");
...
//		theCharScanScript->addFileListBuilder("AddFilesFromFdcCache");
//		theCharScanScript->addFileListBuilder("Since 01/01/2007");
//		theCharScanScript->addFileListBuilder("FileAge 14");
////		theCharScanScript->addFileListBuilder("NewestFile");
//		theCharScanScript->addFileListBuilder("LargestFile");
//
//		theCharScanScript->addFilter("BestSkill 1 1");
//		theCharScanScript->addFilter("NoGuild");
//
...
//		theCharScanScript->writeToFile("lvl1_inactive.pdss_css");
//	}
//
//	return true;
//}
...
//
//		theCharScanScript->setOutputPath("../stats/");
//		theCharScanScript->setOutputName("lvl5_inactive_");
//
//		theCharScanScript->addInfoExtractor("Name");
//		theCharScanScript->addInfoExtractor("Position");
...
//		theCharScanScript->addInfoExtractor("LastActivityDate");
//		theCharScanScript->addInfoExtractor("RecentPlayHistory");
//		theCharScanScript->addInfoExtractor("ActiveMissions");
//
////		theCharScanScript->addFileListBuilder("AddFilesRecurse account_*_pdr.bin");
//		theCharScanScript->addFileListBuilder("AddFilesFromFdcCache");
//		theCharScanScript->addFileListBuilder("Since 01/01/2007");
...
//		theCharScanScript->addFileListBuilder("LargestFile");
//
//		theCharScanScript->addFilter("BestSkill 2 5");
//		theCharScanScript->addFilter("NoGuild");
//
//		// create and launch the new job
//		CSmartPtr<CCharacterScanJob> theJob= new CCharacterScanJob;
...
////		if (noErrors)
////			CJobManager::getInstance()->addJob(&*theJob);
//		theCharScanScript->writeToFile("lvl5_inactive.pdss_css");
//
//	}
//
//	return true;
...
//
//		theCharScanScript->setOutputPath("../stats/");
//		theCharScanScript->setOutputName("inactive_");
//
//		theCharScanScript->addInfoExtractor("Name");
...
////		if (noErrors)
////			CJobManager::getInstance()->addJob(&*theJob);
//		theCharScanScript->writeToFile("inactive.pdss_css");
//	}
//
//	return true;
//}
...
//		return false;
//
//	// generate active accout report
//	{
//		// create a new script object and add the tmp file
//		CSmartPtr<CCharScanScriptFile> theCharScanScript= new CCharScanScriptFile;
//
//		theCharScanScript->setOutputPath("../stats/");
//		theCharScanScript->setOutputName("active_");
//
//		theCharScanScript->addInfoExtractor("Name");
//		theCharScanScript->addInfoExtractor("Race");
...
////		if (noErrors)
////			CJobManager::getInstance()->addJob(&*theJob);
//		theCharScanScript->writeToFile("active.pdss_css");
//	}
//
//	return true;
//}
...
//		return false;
//
//	// generate deep accout report
//	{
//		// create a new script object and add the tmp file
//		CSmartPtr<CCharScanScriptFile> theCharScanScript= new CCharScanScriptFile;
//
//		theCharScanScript->setOutputPath("../stats/");
//		theCharScanScript->setOutputName("deep_");
//
//		theCharScanScript->addInfoExtractor("Name");
//		theCharScanScript->addInfoExtractor("PlayTime");
//		theCharScanScript->addInfoExtractor("ActivityDuration");
...
////		theCharScanScript->addFileListBuilder("AddFilesRecurse account_*_pdr.bin");
//		theCharScanScript->addFileListBuilder("AddFilesFromFdcCache");
//		theCharScanScript->addFileListBuilder("Since 1/1/2006");
//		theCharScanScript->addFileListBuilder("FileAge 14");
////		theCharScanScript->addFileListBuilder("NewestFile");
//		theCharScanScript->addFileListBuilder("LargestFile");
//
...
////		if (noErrors)
////			CJobManager::getInstance()->addJob(&*theJob);
//		theCharScanScript->writeToFile("deep.pdss_css");
//	}
//
//	return true;
//}
...
static std::string getActiveOutputPath()
{
	...
	script.parseFile(TmpScriptFileName);
